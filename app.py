...
# Paths to CSV files
internship_data_path = r"D:\FIB\inter.csv"
...
@app.route('/')
def home():
    return redirect(url_for('index'))  # Redirect root to login page
...
def recommend():
    ...
    return render_template('recommendations.html', internships=recommended_internships)  # Changed to recommendations.html
